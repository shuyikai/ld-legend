...
namespace ET.Client
{
	[ChildOf]
	[EnableMethod]
	public  class ES_JoystickWalk : Entity,ET.IAwake<UnityEngine.Transform>,IDestroy 
	{
		...
		public UnityEngine.EventSystems.EventTrigger E_YaoGanDiMoveEventTrigger
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_YaoGanDiMoveEventTrigger = UIFindHelper.FindDeepChild<UnityEngine.EventSystems.EventTrigger>(this.uiTransform.gameObject,"E_YaoGanDiMove");
     			}
		...
		public UnityEngine.EventSystems.EventTrigger E_YaoGanDiFixEventTrigger
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_YaoGanDiFixEventTrigger = UIFindHelper.FindDeepChild<UnityEngine.EventSystems.EventTrigger>(this.uiTransform.gameObject,"E_YaoGanDiFix");
     			}
		...
		public UnityEngine.UI.Image E_CenterShowImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_CenterShowImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_YaoGanDiFix/E_CenterShow");
     			}
